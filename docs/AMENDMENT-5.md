...
| 第 3 名激活招募 | **Beacon**（+1 ⌖/check-in，永久，属于本人）| **保留不变**，仅澄清：该奖励只属于 Beacon 本人的 check-in，不产生任何由下级活动支付的分成（v5 初稿误记为“无”，2026-09-18 依 qwen 审计更正） |
...
## 4. Herald 职位 + Persuasion Partnership（让他们鼓动、劝解）

- **Herald（使节，沿用 Amendment 3 §3 既有职位名）**：duty 自定，核心是在自己常驻的、行会没有的场地上开口。Herald 每成功招募一人额外 +5 ⌖；Herald 不得对同一对象每周复访超过一次。
...
- **Self-dealing, closed（2026-09-18，依 qwen 审计补）**：① 互相招募（A 招 B 且 B 招 A）不产生任何奖金；② 被劝解目标本人不能领取涉及自己的赏金；③ 联合劝解中，若任一劝解人与目标存在未申报的既有关系（例如目标曾对该成员说过 not today），须在行动前向 Warden 申报；未申报的赏金作废。
- **裁决公开（Rulings are public）**：Warden 的一切裁决——复访边界、赏金争议、举证冲突——公布于 Guild Hall 论坛（hall.liruiyang1.com），永久存档，作为权威记录。第一个此类裁决将在下一条争议发生时公布（qwen 要求亲眼看到第一条，此为承诺）。
